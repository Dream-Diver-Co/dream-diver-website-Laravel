                          ...
                          <div class="flex-grow-1">
                            <div class="timeline-box rounded-4 p-3" >
                              ...
                              <p>
                                    ...
                                    <a class="" href="<?php echo e(route('trusted')); ?>">Read more..</a>
                              </p>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="flex-grow-1">
                            <div class="timeline-box rounded-4 p-3" >
                                ...
                                <p>
                                      ...
                                      <a class="" href="<?php echo e(route('reasonable')); ?>">Read more..</a>
                                </p>
                              </div>
                          </div>
                        </div>
                          ...
                          <div class="flex-grow-1">
                            <div class="timeline-box rounded-4 p-3" >
                              ...
                              <p>
                                    ...
                                    <a class="" href="<?php echo e(route('twonty_four')); ?>">Read more..</a>
                              </p>
                            </div>
                          </div>
                        </div>
                                        ...
                                        <div class="flip-box">
                                            <div class="flip-box-inner">
                                              <div class="flip-box-front">
                                                <img class="img-service" src="<?php echo e(asset('storage/' . $service->service_image)); ?>" alt="Paris">
                                              </div>
                                              <div class="flip-box-back">
                                                <img class="img-service" src=" <?php echo e(asset('storage/' . $service->service_image)); ?> " alt="Paris">
                                                <div class="flip-text">
                                                    <h2>Dream Diver</h2>
                                                    <p><?php echo e($service->service_title); ?></p>
                                                    <button class="flip-btn">Read more...</button>
                                                </div>
                                              </div>
                                            </div>
                                            <div>
                                                <p class="service-item-text"><?php echo e($service->service_title); ?></p>
                                            </div>
                                        </div>
                                    </a>
                                </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\office\dream diver new git\ddyounus\resources\views/frontend/index.blade.php ENDPATH**/ ?>