<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      <img src="<?php echo e(asset('dist/img/logo.png')); ?>" alt="Dream Diver Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('home_service_index')); ?>" class="nav-link ">
                    <i class="nav-icon fas fa-angle-right"></i>
                  <p>Home Service All</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('home_service_create')); ?>" class="nav-link ">
                    <i class="nav-icon fas fa-angle-right"></i>
          ...
          <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('projectsingle.index')); ?>" class="nav-link ">
                  <i class="nav-icon fas fa-angle-right"></i>
                  <p>Project Single view all</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('projectsingle.create')); ?>" class="nav-link ">
                    <i class="nav-icon fas fa-angle-right"></i>
          ...
          <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('contact_form_index')); ?>" class="nav-link ">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('contact_form_create')); ?>" class="nav-link ">
                    <i class="nav-icon fas fa-angle-right"></i>
          ...
          <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('basicticket_index')); ?>" class="nav-link ">
          ...
          <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
                ...
                <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'admin')): ?>
              <li class="nav-item">
                <a href="<?php echo e(route('tickets.index')); ?>" class="nav-link ">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('myticket')); ?>" class="nav-link ">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('tickets.create')); ?>" class="nav-link ">
                    <i class="nav-icon fas fa-angle-right"></i>
                  <p>Ticket Create</p>
                </a>
              </li>
...
<?php /**PATH G:\office\dream diver new git\ddyounus\resources\views/aside.blade.php ENDPATH**/ ?>